import { AddPrivateDiningImagesComponent } from './add-private-dining-images/add-private-dining-images.component';
...
@Component({
  selector: 'private-dining-images',
  templateUrl: './private-dining-images.component.html',
  styleUrls: ['./private-dining-images.component.scss']
})
export class PrivateDiningImagesComponent extends BaseComponent implements OnInit {
  images: any[];
  total: number = 0;
  form!: FormGroup;
  ...
  loadData() {
    ...
    this.httpService.GET(SettingsController.PrivateDiningImages, filters)
  ...
  create() {
    const modalRef = this.modalService.open(AddPrivateDiningImagesComponent, {
      ...ngbModalOptions,
