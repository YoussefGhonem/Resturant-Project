        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TouchAbout = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConntactUs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoverLatter = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    privateDiningCoverAttachmentName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    privateDiningCoverAttachmentPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ManuAttachmentName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ManuAttachmentPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutAttachmentName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutAttachmentPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealNames_SubCategories_SubcategoryId",
